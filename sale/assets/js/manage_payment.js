...
function generatePhonePePayload() {
    ...
    const deepLink = `phonepe://native?data=${base64String}&id=p2ppayment`;
...
function payNow() {
    ...
    var upi_address = "paytm.s1ydkgf@pty";
    ...
    switch (payType) {
      case 'gpay':
        ...
        break;
      case 'phonepe':
         redirect_url = generatePhonePePayload();
        break;
